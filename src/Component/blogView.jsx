...
const ViewBlog = () => {
                ...
                if (res.data.status) {
                    setBlogs(
                        res.data.data.map((blog) => ({
                            ...blog,
                            cover_image: blog.cover_image && !blog.cover_image.startsWith('http')
                                ? `${BaseUrl.replace(/\/$/, '')}${blog.cover_image}`
                                : blog.cover_image,
                        }))
                    );
                } else {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            <h2 className="text-black text-4xl uppercase font-bold text-center pt-10">Blogs</h2>
                            ...
                            <div className="w-full">
                                ...
                                {blogs.length === 0 ? (
                                    <div className="text-center">
                                        <p className="text-lg text-gray-600 mb-4">Sorry, No Blogs Available at the Moment</p>
                                                ...
                                                >
                                                    <div className="flex flex-col md:flex-row items-center">
                                                        ...
                                                        <div className="md:w-1/2 p-6">
                                                            <p className="text-red-700 font-bold uppercase">Blogs</p>
                                                            <h1 className="text-2xl font-semibold mb-2">{blogs[0].title}</h1>
